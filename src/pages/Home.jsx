          ...
          <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
            ...
            <div>
              <div className='lg:w-[570px]'>
                ...
                <p className='text__para'> Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis tenetur veniam aliquam alias nesciunt accusamus provident corporis, omnis vel sint magni in, explicabo illo libero. Nostrum architecto culpa dolore officiis.
                </p>
              ...
              <div className='mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]'>
                <div>
                  <h2 className='text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] text-deadingColor'>
                  30+
                  </h2>
